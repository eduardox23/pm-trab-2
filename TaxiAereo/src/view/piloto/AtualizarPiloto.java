 ...
 * Edu3500
 */
public class AtualizarPiloto extends BaseView {

	private ViewerPiloto home;
	
	public AtualizarPiloto(ViewerPiloto home) {
		this.home=home;
		initComponents();
	}
    ...
    private void BuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BuscarMouseClicked
		try
		{
			...
			salarioTextField.setText( Common.bigDecimalFormat(piloto.getSalario()) );
        }
		catch (Exception ex) {
			tratarErro(ex);
		}
    ...
    private void AtualizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AtualizarMouseClicked
		...
		boolean confirmou = mostrarMensagemConfirmacao("Atualizar Piloto?");
		
		if(confirmou)
		{
			try {
				Piloto piloto = new Piloto();
				piloto.setNome(nomeTextField.getText());
				piloto.setCpf(cpfTextField.getText());
				piloto.setRg(rgTextField.getText());
				piloto.setLogradouro(logradouroTextField.getText());
				piloto.setNumeroCasa(numeroTextField.getText());
				piloto.setCep(cepTextField.getText());
				piloto.setDataContrato(dataTextField.getText());
				piloto.setSalario( salarioTextField.getText() );

				PilotoController.alterar(piloto);

				mostrarMensagemSucesso("Piloto alterado com sucesso!");
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(AtualizarPiloto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new AtualizarPiloto(null).setVisible(true);
			}
		});
	}
