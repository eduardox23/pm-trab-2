 ...
 * Edu3500
 */
public class BuscarVendedor extends BaseView {

	private ViewerVendedor home;
	public BuscarVendedor(ViewerVendedor home) {
		this.home=home;
		initComponents();
	}
    ...
    private void BuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BuscarMouseClicked
        try
		{
			...
			salarioTextField.setText(String.valueOf(vendedor.getSalario()));
        }
		catch (Exception ex) {
			tratarErro(ex);
		}
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(BuscarVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new BuscarVendedor(null).setVisible(true);
			}
		});
	}
