 ...
 * Edu3500
 */
public class RemoverVendedor extends BaseView {

	private ViewerVendedor home;
	public RemoverVendedor(ViewerVendedor home) {
		this.home=home;
		initComponents();
	}
    ...
    private void RemoverMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RemoverMouseClicked
		...
		boolean confirmou = mostrarMensagemConfirmacao("Remover Vendedor?");
		...
		if(confirmou)
		{
			try 
			{
				...
				VendedorController.excluir( vendedor.getMatricula() );
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(RemoverVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new RemoverVendedor(null).setVisible(true);
			}
		});
	}
